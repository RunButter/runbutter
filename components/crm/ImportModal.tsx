              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input value={url} onChange={(e) => setUrl(e.target.value)} placeholder="https://docs.google.com/…/pub?output=csv"
                    className="flex-1 h-9 px-2.5 text-[13px] rounded-md bg-surface ring-1 ring-subtle focus:ring-2 focus:ring-primary-500 outline-none" />
            ...
            <div className="space-y-3">
              ...
              {fields.map((f) => (
                <div key={f.key} className="flex items-center gap-3">
                  <span className="w-32 shrink-0 text-[13px] font-medium text-secondary">{f.label}{f.required && <span className="text-rose-500"> *</span>}</span>
