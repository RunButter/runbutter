    ...
    return (
        <div className="relative min-h-[60vh]">
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center p-6">
                <div className="bg-white/90 backdrop-blur-xl border border-gray-100 p-10 rounded-3xl shadow-2xl max-w-md w-full text-center">
                    ...
                    <h2 className="text-2xl font-black text-gray-900 mb-2 tracking-tight">{label || 'Premium feature'}</h2>
                    <p className="text-gray-500 mb-6 text-sm">
                        This is included from the <span className="font-bold text-gray-800">{neededName}</span> plan. Upgrade to unlock it.
                    </p>
