        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-[2px] p-4" onClick={onClose}>
            <div className="bg-surface rounded-2xl shadow-popover w-full max-w-xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-5 space-y-4">
                    ...
                    <p className="text-2xs text-tertiary">Variables like <code className="px-1 bg-surface-hover rounded">{'{{first_name}}'}</code> are filled in automatically when sent.</p>
