    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-sm w-full bg-surface rounded-xl ring-1 ring-subtle shadow-sm p-8 text-center">
          ...
          <p className="mt-1.5 text-[13px] text-secondary">Open it from your workspace, or sign in first.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="w-80 shrink-0 border-l border-subtle bg-surface overflow-y-auto">
          <div className="p-4 space-y-3 border-b border-subtle">
            <div className="text-[11px] font-semibold uppercase tracking-widest text-tertiary">Post</div>
            <div>
              <label className="block text-[12px] font-semibold text-secondary mb-1">Platform</label>
          ...
          <div className="p-4">
            <div className="flex items-center gap-1.5 mb-3">
              ...
              <span className="text-[11px] font-semibold uppercase tracking-widest text-tertiary">Comments</span>
              <span className="text-[11px] font-semibold text-tertiary bg-surface-hover rounded px-1.5 tabular-nums">{post.comments.filter((c) => !c.resolved).length}</span>
            </div>
            {post.comments.length === 0 && <p className="text-[12px] text-tertiary">No comments yet — click the post preview to add one.</p>}
