      ...
      <div className="flex-1 overflow-auto p-6 2xl:p-8">
        {loading ? (
          ...
          <div className="max-w-5xl grid lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl ring-1 ring-subtle p-3.5 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-2xs font-medium uppercase tracking-widest text-tertiary">Legal identity — shown on invoices</span>
              ...
              <div className="rounded-xl ring-1 ring-subtle p-3.5 space-y-3">
                <span className="text-2xs font-medium uppercase tracking-widest text-tertiary">Bank — for payment on invoices</span>
                <div>
              ...
              <div className="rounded-xl ring-1 ring-subtle p-3.5 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-2xs font-medium uppercase tracking-widest text-tertiary">Careers &amp; apply</span>
              ...
              {/* ── Link previews ─────────────────────────────────────────── */}
              <div className="rounded-xl ring-1 ring-subtle p-3.5 space-y-3">
                <span className="text-2xs font-medium uppercase tracking-widest text-tertiary">Link previews</span>
              ...
              {/* ── Email ─────────────────────────────────────────────────── */}
              <div className="rounded-xl ring-1 ring-subtle p-3.5 space-y-3">
                <span className="text-2xs font-medium uppercase tracking-widest text-tertiary">Email</span>
                <div>
            ...
            {/* Live preview */}
            <div>
              <div className="text-3xs font-medium uppercase tracking-widest text-tertiary mb-2">Preview</div>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-md font-medium text-primary">{displayName}</div>
