  ...
  return (
    <>
      <header className="h-12 shrink-0 flex items-center gap-3 px-4 border-b border-slate-200/70">
        <h1 className="text-sm font-bold text-slate-800">Issues</h1>
        ...
        <div className="ml-1 flex items-center rounded-md ring-1 ring-slate-200/70 overflow-hidden">
          ...
          <Link href="/objects/issues" className="h-7 px-2 inline-flex items-center gap-1.5 text-[12px] font-medium text-slate-400 hover:bg-slate-50"><Table2 className="w-3.5 h-3.5" /> Table</Link>
        </div>
        <button className="ml-auto h-7 px-2.5 inline-flex items-center gap-1.5 rounded-md text-[12px] font-bold text-white bg-primary-600 hover:bg-primary-700 transition-colors shadow-sm"><Plus className="w-3.5 h-3.5" /> New issue</button>
      </header>
