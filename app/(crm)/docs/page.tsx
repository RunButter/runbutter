        ...
        <div className="max-w-5xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="rounded-xl ring-1 ring-subtle bg-surface px-6 py-12 text-center">
              ...
              <p className="text-sm text-secondary mb-3">No documents yet.</p>
              <button onClick={create} disabled={!canEdit} className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg text-sm font-semibold text-inverse-fg bg-inverse hover:bg-inverse/90 disabled:opacity-40">Create your first</button>
            </div>
          ) : (
