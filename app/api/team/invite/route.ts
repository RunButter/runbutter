            ...
            await resend.emails.send({
                ...
                html: `
                    <div style="font-family: Arial, sans-serif; padding: 20px;">
                        ...
                        <br/>
                        <a href="https://talentinsight.hirebtr.com/auth/login" style="background-color: #4F46E5; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">Accept Invitation & Setup Account</a>
