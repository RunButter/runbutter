...
-- Additive & prod-safe. Depends on 0001–0020. Run AFTER them.
-- ============================================================================
...
-- list_records — companies expose tax_id/address/country (from 0019 + fields).
...
-- get_record — companies include tax_id/address/country (from 0019 + fields).
...
-- create_record — companies set tax_id/address/country (from 0019 + fields).
...
-- update_record — companies set tax_id/address/country (from 0019 + fields).
